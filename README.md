...
# Here is a new version of 'ESM2 (pML) linked to LR (Logistic Regression) Classifier model' training for detectability of noncanonical ORF microprotein sequences by Mass Spectrometry, referred as ESM2_LR_Classifier_v2
